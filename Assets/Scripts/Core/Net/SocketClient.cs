...
public class SocketClient {
    ...
    public event OnConnect OnConnectHandler;
    public event OnDisconnect OnDisconnectHandler;
    public event OnReceive OnReceiveHandler;
